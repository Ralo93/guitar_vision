...
<div align="center">
    ...
    <p>Image from <a href="https://pixabay.com/">Pixabay</a></p>
</div>
...
In this example, we also use an A-Major chord, and its easiy to spot which pitches are the most dominant: A (the root), C# (major third) and E (perfect fifth) which make up the A-Major chord. You can listen to it here:
